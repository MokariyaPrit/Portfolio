    ...
    <StyledWrapper>
      <ul className="example-2">
        <li className="icon-content">
          <a href="www.linkedin.com/in/prit-mokariya" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/MokariyaPrit" aria-label="GitHub" data-social="github">
            <div className="filled" />
